...
class TrackDownloaderView(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox.setItemText(0, QtGui.QApplication.translate("Form", "All", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(1, QtGui.QApplication.translate("Form", "Best", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(2, QtGui.QApplication.translate("Form", "High", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox.setItemText(3, QtGui.QApplication.translate("Form", "Low", None, QtGui.QApplication.UnicodeUTF8))
